...
public class BookingController 
{
	...
	public String addUserDetails(@Valid @RequestBody UserDetails userDetails)
	{
		...
		restTemplate.getForObject("http://Fare-Service/admin/updateSeats/"+flightNo +"/"+totalPassengers, FlightDetails.class);
	...
	RestTemplate restTemplate = new RestTemplate();
	restTemplate.getForObject("http://Payment-Service/pay/cancel/"+pnrNo, String.class);
