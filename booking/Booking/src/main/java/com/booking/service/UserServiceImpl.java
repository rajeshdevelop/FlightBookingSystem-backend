...
//to get autogenerated id
	...
	public void sendEmail(long pnrNo) throws AddressException {
		...
		final Email email = DefaultEmail.builder().from(new InternetAddress("pujarirajesh324@gmail.com"))
				.replyTo(new InternetAddress("pujarirajesh324@gmail.com"))
				.to(Lists.newArrayList(new InternetAddress("pujarirajesh324@gmail.com"))).subject("Your Flight is booked")
