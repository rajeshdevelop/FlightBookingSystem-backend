...
public class CheckinController {
	...
	private CheckinService checkinService;
	 ...
	 public CheckinDetails addCheckinDetails(@PathVariable long pnrNo) {
		 ...
		 UserDetails user=restTemplate.getForObject("http://Booking-Service/user/get/"+ pnrNo, UserDetails.class);
		 ...
		 FlightDetails fDetails=restTemplate.getForObject("http://Fare-Service/admin/"+ fNo, FlightDetails.class);
